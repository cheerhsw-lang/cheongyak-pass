...
export function Footer() {
  return (
    <footer className="mt-16 border-t border-[var(--line)] bg-[var(--navy)] text-[var(--ivory)]">
      <div className="mx-auto max-w-6xl px-4 py-10">
        <p className="kicker text-[var(--brass-2)]">출처 표기</p>
        <p className="mt-2 text-lg font-bold">{SOURCE_FOOTER}</p>
        <p className="mt-4 max-w-4xl text-[0.98rem] leading-relaxed text-[var(--ivory)]/90">{DISCLAIMER}</p>
